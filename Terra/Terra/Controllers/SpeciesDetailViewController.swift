...
//        view.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.4877193921)
    ...
    private func setUpUIFromSpecies(){
        ...
        weightInfoLabel.text = currentSpecies.weight
        heightInfoLabel.text = currentSpecies.height
    }
